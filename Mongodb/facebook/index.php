                    ...
                    if(getParentPostid($i) === null){
                        if($condition1 || $condition2 || $condition3){
                            ...
                            while(checkPost($n)){
                                ...
                                $responsepostVisibility = getPostVisibility(getPostEmail(getPostpostid($n)));
        
                                $possibility1 = $responseVisibility == 'everyone' && $responsepostVisibility == 'everyone';
                                ...
                                if(getPostBody($n)){
                                    if(getParentPostid($n) === $i){
                                        if($possibility1 || $possibility2 || $possibility3 || $possibility4){
                                            ...
                                            <div class="row"><div class="col-sm-1 bg-light"></div>
        ...
        <div class="friend">
            ...
            <div class="form-group">
                ...
                <label for="un"><b>Find your friends</b></label>
                    <input type="email" class="form-control" name="email" placeholder="User's email.." required>
                    <div class="row m-auto p-2 justify-content-end">
            ...
            <div class="friendrequest border-bottom border-muted">
                ...
                <?php 
                    ...
                    $a = 0;
                    if(getReceiving($myEmail, "applied")){
                        echo '<ul class="list-group list-group-flush bg-light mb-1">';
